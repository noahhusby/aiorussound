...
class MediaManagementMenuItem(DataClassORJSONMixin):
    ...
    is_first: bool | None = field(
        metadata=field_options(alias="isFirst"), default=None
    )
    is_last: bool | None = field(
        metadata=field_options(alias="isLast"), default=None
    )
    is_menu: bool | None = field(
        metadata=field_options(alias="isMenu"), default=None
    )
    ...
    image_url: str | None = field(
        metadata=field_options(alias="imgURL"), default=None
    )
    uri: str | None = None
